...
Taken from: (changed logging to print statements to output as stdout)
    https://github.com/markfickett/minecraftstatus
"""
...
if __name__ == '__main__':
  ...
  server.Update()
  if server.available:
    print ("online_count:" + str(server.num_players_online))
    print ("Playes_are:" + str(server.player_names_sample))
